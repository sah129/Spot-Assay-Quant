...
The data is summarized and compiled using a python script.  If you are familiar with Python you can run the script.  It is available as a Jupyter Notebook file and can be found in the `Scripts` folder.  Otherwise, I am working on hosting the tool on the lab website for easy use.  Until then, email me you "Spreadsheets" folder and I'll run the script for you.
