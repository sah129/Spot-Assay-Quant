...
df = data.frame(
  "Output" = c("Spreadsheets", 
               ...
               "Rows", 
               "Graphs"), 
  "Associated Module" = c("ExportToSpreadsheet",
                          "SaveImages 1", 
                          "SaveImages 2", 
                          "SaveImages 3", 
                          "SaveImages 4", 
...
# Overview
This pipeline batch processes spot assay image sets and outputs all result data to .csv files.  In addition, it outputs a series of supplementary data and result images for spot checking.  You may find that most of this data is unecessary; it was made with a particularly problematic and inconsistent dataset in mind.  I have chosen to keep the auxillary data in for robust testing and verification.  See the `Input and Output` section for more information. 
...
* Graphs:  A place to store any user-generated graphs post-processing.  See the `Post Processing` section for more information.
